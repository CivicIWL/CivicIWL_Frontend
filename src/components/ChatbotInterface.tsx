              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Your friendly government services helper
                    </p>
                  </div>
                </div>
                <Button
                    ...
                    <div className="flex items-center justify-center h-full min-h-[400px]">
                      <div className="text-center max-w-lg">
                        ...
                        <p className="text-slate-600 leading-relaxed mb-8 text-lg">
                          I'm here to help you with government services, from
                          voting to permits to taxes!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-4 text-left">
                          <button
                            onClick={() =>
                              handleSuggestionClick(
                                "How do I register to vote in Kenya? 🗳️",
                              )
                            }
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-slate-600">
                                  Learn how to register with IEBC
                                </p>
                              </div>
                            </div>
                          </button>
                          ...
                          <button
                            onClick={() =>
                              handleSuggestionClick(
                                "When are property rates due in Nairobi? 🏠",
                              )
                            }
                          ...
                          <button
                            onClick={() =>
                              handleSuggestionClick(
                                "How do I get a building permit? 🏗️",
                              )
                            }
                    ...
                    <>
                      {currentSession.messages.map((message, index) => (
                        ...
                        >
                          ...
                          <div
                            className={`max-w-[75%] ${message.type === "user" ? "order-2" : ""}`}
                          >
                            <div
              ...
              {!currentMessage &&
                ...
                (!currentSession || currentSession.messages.length === 0) && (
                  <div className="mt-3 flex flex-wrap gap-2">
                    <button
                      onClick={() =>
                        handleSuggestionClick("🗳️ IEBC registration")
                      }
                    ...
                    <button
                      onClick={() =>
                        handleSuggestionClick("🏠 Nairobi county rates")
                      }
                    ...
                    <button
                      onClick={() =>
                        handleSuggestionClick("🏗️ Building permits")
                      }
                    ...
                    <button
                      onClick={() =>
                        handleSuggestionClick("🚨 Emergency numbers")
                      }
